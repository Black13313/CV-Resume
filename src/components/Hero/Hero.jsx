        ...
        <>
            <div className="relative overflow-hidden shadow-lg">
                ...
                >
                    {/* Image */}
                    <div
                        className="relative -z-20 max-w-[12rem] animate-[scaleUp_0.5s_linear] overflow-hidden sm:min-w-[17rem] md:min-w-[22rem] lg:min-w-[27rem]">
                        <img className="h-full w-full object-cover" src={devtons} alt=""/>
                    </div>

                    {/* Intro Header */}
                    <div
                        className="flex flex-col items-center justify-center gap-2 space-y-2 text-[2rem] sm:space-y-4 sm:text-5xl md:space-y-6 md:text-6xl">
              ...
              <span className="animate-[wiggle_1s_ease-in-out_infinite]">
                👋🏻
                        ...
                        <p className="animate-[fadeLeft_1.1s_linear] text-center text-[1rem] leading-8 text-primary md:text-[1.4rem]">
                            I have more than a year of experience as a website developer, and I mainly use VueJs for
                            building web applications and Express for the backend. As a website developer, I use VueJs
                            for web app development and Express for the backend, and I have over a year of experience.
                        </p>
              ...
              React JS Developer Creating Engaging Web Experiences
                    ...
                    <div className="flex w-full items-center justify-center gap-x-4 md:hidden">
                        ...
                        <a
                            href="https://www.facebook.com/Black13032006/"
                            target="blank"
                            rel="noreferrer"
                        >
                            <img
                        ...
                        <a
                            href="https://github.com/Black13313"
                            target="blank"
                            rel="noreferrer"
                        >
                            <img
